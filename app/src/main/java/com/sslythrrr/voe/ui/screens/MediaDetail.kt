...
import com.sslythrrr.voe.ui.media.MediaAction
import com.sslythrrr.voe.ui.media.MediaNavbar
...
fun MediaDetailScreen(
    ...
    LaunchedEffect(lazyPagingItems?.itemCount, initialMediaId) {
    ...
    val shouldShowControls = showControls
